...
class MiComponente {
    ...
    crearBoton() {
        ...
        boton.textContent = "\xa1Haz clic aqu\xed!";
        ...
        boton.addEventListener('click', ()=>{
            alert(`\xa1Hola, ${this.nombre}! Has hecho clic en el bot\xf3n.`);
        });
        return boton;
    }
    ...
    render() {
        ...
        mensaje.innerHTML = `\xa1Hola, ${this.nombre}! Este es mi primer componente.`;
